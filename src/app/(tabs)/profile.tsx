  ...
  return (
    <ScreenContainer scrollable className="py-6">
      ...
      <View className="items-center mb-8">
        <View className="w-24 h-24 rounded-full bg-muted items-center justify-center mb-4 border border-border">
          <SymbolView name="person.fill" size={48} tintColor={theme.textSecondary} />
        </View>
        <Text variant="subtitle" className="text-2xl font-bold">Username</Text>
        <Text variant="muted">Developer</Text>
      </View>
      ...
      <View className="flex-col lg:flex-row gap-6">
        ...
        <Card className="flex-1">
          <CardHeader className="flex-row items-center justify-between">
            ...
            <Badge variant="outline" label="Not Connected" />
          </CardHeader>
          <CardContent>
